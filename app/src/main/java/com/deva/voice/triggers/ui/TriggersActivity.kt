package com.deva.voice.triggers.ui
...
import com.deva.voice.BaseNavigationActivity
import androidx.recyclerview.widget.LinearLayoutManager
import androidx.recyclerview.widget.RecyclerView
import com.deva.voice.R
import com.deva.voice.triggers.TriggerManager
import com.deva.voice.triggers.TriggerMonitoringService
import com.deva.voice.triggers.TriggerType
...
class TriggersActivity : BaseNavigationActivity() {
    ...
    private fun showBatteryOptimizationWarning(onAcknowledge: () -> Unit) {
        val dialog = AlertDialog.Builder(this)
            ...
            .setMessage("Your vendor might not support DeVA background trigger monitoring. To ensure DeVA works properly, please disable any kind of battery optimization for the app.")
    ...
    private fun checkNotificationPermission() {
        ...
        if (hasNotificationTriggers && !com.deva.voice.triggers.PermissionUtils.isNotificationListenerEnabled(this)) {
    ...
    private fun showPermissionDialog() {
        val dialog = AlertDialog.Builder(this)
            ...
            .setMessage("To use notification-based triggers, you need to grant DeVA the Notification Listener permission in your system settings.")
    ...
    private fun showDeleteConfirmationDialog(trigger: com.deva.voice.triggers.Trigger) {
        val dialog = AlertDialog.Builder(this)
