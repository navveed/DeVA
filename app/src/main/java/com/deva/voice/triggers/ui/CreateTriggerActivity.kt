...
import com.deva.voice.triggers.PermissionUtils
import com.deva.voice.triggers.Trigger
...
//        }
    ...
    private fun saveTrigger() {
        ...
        when (selectedTriggerType) {
            TriggerType.SCHEDULED_TIME -> {
                if (!com.deva.voice.triggers.PermissionUtils.canScheduleExactAlarms(this)) {
    ...
    private fun showExactAlarmPermissionDialog() {
        val dialog = androidx.appcompat.app.AlertDialog.Builder(this)
            ...
            .setMessage("To schedule tasks at a precise time, DeVA needs the 'Alarms & Reminders' permission. Please grant this in the next screen.")
