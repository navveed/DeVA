...
//import com.deva.voice.services.AgentTaskService
...
import com.deva.voice.agents.ClarificationAgent
import com.deva.voice.utilities.TTSManager
import com.deva.voice.utilities.addResponse
import com.deva.voice.utilities.getReasoningModelApiResponse
...
import com.deva.voice.data.UserMemory
...
import com.deva.voice.utilities.ServicePermissionManager
...
class ConversationalAgentService : Service() {
    ...
    private val devaStateManager by lazy { DeVAStateManager.getInstance(this) }
    ...
    companion object {
        ...
        const val ACTION_STOP_SERVICE = "com.deva.voice.ACTION_STOP_SERVICE"
        var isRunning = false
    ...
    override fun onCreate() {
        ...
        devaStateManager.setState(DeVAState.IDLE)
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        serviceScope.launch {
            ...
            devaStateManager.setState(DeVAState.LISTENING)
    ...
    private suspend fun startImmediateListening() {
        ...
        speechCoordinator.startListening(
            onResult = { recognizedText ->
                ...
                devaStateManager.setState(DeVAState.PROCESSING)
            ...
            onError = { error ->
                ...
                devaStateManager.triggerErrorState()
...
//        }
        ...
        devaStateManager.setState(DeVAState.SPEAKING)
        speechCoordinator.speakText(text)
        Log.d("ConvAgent", "DeVA said: $text")
...
//    }
    ...
    private fun initializeConversation() {
        val memoryContextSection = if (MEMORY_ENABLED) {
            ...
            """
            ### Memory Status ###
            Memory system is temporarily disabled. DeVA cannot remember or learn from previous conversations at this time.
        ...
        val systemPrompt = """
            You are a helpful voice assistant called DeVA that can either have a conversation or ask an executor to execute tasks on the user's phone.
