...
import com.deva.voice.AudioWaveView
import com.deva.voice.R
import com.deva.voice.ui.SmallDeltaGlowView
...
import com.deva.voice.utilities.TtsVisualizer
...
class VisualFeedbackManager private constructor(private val context: Context) {
    ...
    private val devaStateManager by lazy { DeVAStateManager.getInstance(context) }
    private val stateChangeListener: (DeVAState) -> Unit
    ...
    fun showSmallDeltaGlow() {
        mainHandler.post {
            ...
            try {
                ...
                updateSmallDeltaVisuals(devaStateManager.getCurrentState())
     ...
     */
    private fun updateSmallDeltaVisuals(state: DeVAState) {
