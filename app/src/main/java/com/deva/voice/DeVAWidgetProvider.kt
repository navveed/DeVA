...
class DeVAWidgetProvider : AppWidgetProvider() {
    ...
    override fun onUpdate(
        ...
        for (appWidgetId in appWidgetIds) {
            ...
            intent.action = "com.deva.voice.WAKE_UP_DEVA"
            ...
            val views = RemoteViews(context.packageName, R.layout.deva_widget_layout)
