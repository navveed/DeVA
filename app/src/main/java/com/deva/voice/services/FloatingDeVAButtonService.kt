...
class FloatingDeVAButtonService : Service() {

    private var windowManager: WindowManager? = null
    private var floatingButton: View? = null

    companion object {
        private const val TAG = "FloatingDeVAButton"
        var isRunning = false
    }
    ...
    override fun onCreate() {
        super.onCreate()
        isRunning = true
        Log.d(TAG, "Floating DeVA Button Service created")
    }

    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        Log.d(TAG, "Floating DeVA Button Service starting...")
    ...
    private fun showFloatingButton() {
        ...
        try {
            ...
            button.setOnClickListener {
                Log.d(TAG, "Floating DeVA button clicked!")
                triggerDeVAActivation()
            }
            ...
            Log.d(TAG, "Floating DeVA button added successfully")
        } catch (e: Exception) {
    ...
    private fun createFloatingView(): Button {
        return Button(this).apply {
            ...
            background = ContextCompat.getDrawable(context, R.drawable.floating_deva_text_background)
    ...
    private fun triggerDeVAActivation() {
        try {
    ...
    override fun onDestroy() {
        super.onDestroy()
        Log.d(TAG, "Floating DeVA Button Service destroying...")
        hideFloatingButton()
        isRunning = false
    }
