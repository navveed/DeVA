...
⚠️ **DeVA memory is turned off as of yet.**

The memory functionality in DeVA has been temporarily disabled while we work on improvements and optimizations. This means:

## What's Affected

- **Conversational Memory**: DeVA will not remember information from previous conversations
- **Personal Information Storage**: No personal details will be stored or recalled
- **Learning from Interactions**: DeVA won't learn from your preferences or habits
...
- **Screen Understanding**: DeVA can still see and interact with your screen
...
- Remember that DeVA won't recall previous interactions
